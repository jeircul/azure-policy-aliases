...
| Default Path | Alias |
|---|---|
| `properties.publisher` | `Microsoft.Chaos/targets/capabilities/publisher` |
| `properties.targetType` | `Microsoft.Chaos/targets/capabilities/targetType` |
| `properties.description` | `Microsoft.Chaos/targets/capabilities/description` |
