...
| `properties.meshProperties` | `Microsoft.ContainerService/fleets/members/meshProperties` |
| `properties.meshProperties.ciliumProperties` | `Microsoft.ContainerService/fleets/members/meshProperties.ciliumProperties` |
| `properties.meshProperties.ciliumProperties.id` | `Microsoft.ContainerService/fleets/members/meshProperties.ciliumProperties.id` |
| `properties.meshProperties.ciliumProperties.name` | `Microsoft.ContainerService/fleets/members/meshProperties.ciliumProperties.name` |
| `properties.meshProperties.status` | `Microsoft.ContainerService/fleets/members/meshProperties.status` |
| `properties.meshProperties.status.state` | `Microsoft.ContainerService/fleets/members/meshProperties.status.state` |
| `properties.meshProperties.status.lastUpdatedAt` | `Microsoft.ContainerService/fleets/members/meshProperties.status.lastUpdatedAt` |
| `properties.meshProperties.status.lastOperationId` | `Microsoft.ContainerService/fleets/members/meshProperties.status.lastOperationId` |
| `properties.meshProperties.status.error` | `Microsoft.ContainerService/fleets/members/meshProperties.status.error` |
| `properties.meshProperties.status.error.code` | `Microsoft.ContainerService/fleets/members/meshProperties.status.error.code` |
| `properties.meshProperties.status.error.message` | `Microsoft.ContainerService/fleets/members/meshProperties.status.error.message` |
| `properties.meshProperties.status.error.target` | `Microsoft.ContainerService/fleets/members/meshProperties.status.error.target` |
| `properties.meshProperties.status.error.details` | `Microsoft.ContainerService/fleets/members/meshProperties.status.error.details` |
| `properties.meshProperties.status.error.details[*]` | `Microsoft.ContainerService/fleets/members/meshProperties.status.error.details[*]` |
| `properties.meshProperties.status.error.additionalInfo` | `Microsoft.ContainerService/fleets/members/meshProperties.status.error.additionalInfo` |
| `properties.meshProperties.status.error.additionalInfo[*]` | `Microsoft.ContainerService/fleets/members/meshProperties.status.error.additionalInfo[*]` |
| `properties.meshProperties.clusterMeshProfileResourceId` | `Microsoft.ContainerService/fleets/members/meshProperties.clusterMeshProfileResourceId` |
