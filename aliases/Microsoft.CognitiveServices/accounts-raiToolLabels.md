...
| Default Path | Alias |
|---|---|
| `properties.toolConnectionName` | `Microsoft.CognitiveServices/accounts/raiToolLabels/toolConnectionName` |
| `properties.accountScope` | `Microsoft.CognitiveServices/accounts/raiToolLabels/accountScope` |
| `properties.accountScope.labelValues` | `Microsoft.CognitiveServices/accounts/raiToolLabels/accountScope.labelValues` |
