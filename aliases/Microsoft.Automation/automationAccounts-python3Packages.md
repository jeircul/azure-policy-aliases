...
| Default Path | Alias |
|---|---|
| `properties.contentLink` | `Microsoft.Automation/automationAccounts/python3Packages/contentLink` |
| `properties.contentLink.uri` | `Microsoft.Automation/automationAccounts/python3Packages/contentLink.uri` |
| `properties.contentLink.contentHash` | `Microsoft.Automation/automationAccounts/python3Packages/contentLink.contentHash` |
